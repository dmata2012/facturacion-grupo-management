...
/**
 * Presupuesto en PDF, generado al vuelo desde lo que hay en la base.
 *
 * No se guarda en disco a propósito: el documento siempre refleja el
 * presupuesto vigente, no queda una copia que se desincronice, y el sistema
 * no depende del almacenamiento de archivos.
 */
